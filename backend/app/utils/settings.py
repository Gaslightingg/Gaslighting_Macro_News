...
class Settings(BaseSettings):
    ...
    tests_cache_ttl_seconds: int = Field(default=21600, validation_alias="TESTS_CACHE_TTL_SECONDS")
    tests_ai_enabled: bool = Field(default=False, validation_alias="TESTS_AI_ENABLED")
    tests_ai_provider: str = Field(default="none", validation_alias="TESTS_AI_PROVIDER")
    tests_ai_api_key: Optional[str] = Field(default=None, validation_alias="TESTS_AI_API_KEY")
    tests_ai_model: str = Field(default="gpt-4o-mini", validation_alias="TESTS_AI_MODEL")
